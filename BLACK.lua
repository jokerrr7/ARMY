...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1962004752,1765160742}
print("\27[34m"..[[

>> Best Source in Telegram
>> Features BLABAIR and powerful
...
--------------------
io.popen("mkdir BLABAIR_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls BLABAIR_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."BLABAIR:Sudo:User", msg.sender_user_id_) 
if hash or DevBLABAIR(msg) or DevBOYKAW(msg) then  
return true  
else  
return false  
end  
...
if hash or DevBLABAIR(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevBLABAIR(msg) or DevBOYKAW(msg)  or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."BLABAIR:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevBLABAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."BLABAIR:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevBLABAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."BLABAIR:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevBLABAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."BLABAIR:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevBLABAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1962004752) then  
var = true  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then
var = true  
elseif database:sismember(bot_id.."BLABAIR:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."BLABAIR:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."BLABAIR:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."BLABAIR:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."BLABAIR:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."BLABAIR:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(1962004752) then  
var = "مبرمج السورس "
elseif DevBLABAIRe(user_id) == true then
var = "المطور الاساسي"  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."BLABAIR:Sudo:User", user_id) then
var = database:get(bot_id.."BLABAIR:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."BLABAIR:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."BLABAIR:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."BLABAIR:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."BLABAIR:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."BLABAIR:Manager"..chat_id, user_id) then
var = database:get(bot_id.."BLABAIR:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."BLABAIR:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."BLABAIR:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."BLABAIR:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."BLABAIR:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."BLABAIR:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."BLABAIR:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."BLABAIR:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."BLABAIR:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."BLABAIR:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local UserName = (data.username_ or "SOURCE_ARMY")
for BLABAIR in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = BLABAIR
end
...
database:sadd(bot_id..'BLABAIR:Chek:Groups',idg) 
database:set(bot_id.."BLABAIR:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'BLABAIR:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."BLABAIR:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."BLABAIR:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."BLABAIR:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."BLABAIR:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."BLABAIR:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function BLABAIR_Files(msg)
for v in io.popen('ls BLABAIR_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("BLABAIR_Files/"..v)
if plugin.BLABAIR and msg then
pre_msg = plugin.BLABAIR(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function BLABAIR_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'BLABAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'BLABAIR:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."BLABAIR:BLABAIR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."BLABAIR:BLABAIR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."BLABAIR:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'BLABAIR:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'BLABAIR:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'BLABAIR:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'BLABAIR:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."BLABAIR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."BLABAIR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."BLABAIR:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."BLABAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."BLABAIR:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."BLABAIR:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."BLABAIR:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."BLABAIR:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."BLABAIR:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."BLABAIR:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."BLABAIR:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."BLABAIR:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."BLABAIR:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."BLABAIR:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."BLABAIR:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."BLABAIR:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."BLABAIR:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."BLABAIR:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."BLABAIR:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."BLABAIR:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."BLABAIR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."BLABAIR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."BLABAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◍ تم الغاء وضع الوصف") 
database:del(bot_id.."BLABAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."BLABAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."BLABAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◍ تم الغاء حفظ الترحيب") 
database:del(bot_id.."BLABAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."BLABAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."BLABAIR:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"◍ تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."BLABAIR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"◍ تم الغاء حفظ الرابط")       
database:del(bot_id.."BLABAIR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."BLABAIR:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."BLABAIR:BLABAIR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه للخاص") 
database:del(bot_id.."BLABAIR:BLABAIR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'BLABAIR:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."BLABAIR:BLABAIR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."BLABAIR:BLABAIR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."BLABAIR:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."BLABAIR:BLABAIR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."BLABAIR:BLABAIR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."BLABAIR:BLABAIR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."BLABAIR:BLABAIR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."BLABAIR:UsersBot")   
...
local BLABAIR_Msg = database:get(bot_id.."BLABAIR:Add:Filter:Rp2"..text..msg.chat_id_)   
if BLABAIR_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","◍ "..BLABAIR_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."BLABAIR:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."BLABAIR:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."BLABAIR:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."BLABAIR:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "◍ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."BLABAIR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."BLABAIR:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◍ ارسل الامر الجديد")  
database:del(bot_id.."BLABAIR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."BLABAIR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."BLABAIR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."BLABAIR:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."BLABAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."BLABAIR:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◍ تم حفظ الامر")  
database:del(bot_id.."BLABAIR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."BLABAIR:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."BLABAIR:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."BLABAIR:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."BLABAIR:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."BLABAIR:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."BLABAIR:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."BLABAIR:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."BLABAIR:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."BLABAIR:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'BLABAIR:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."BLABAIR:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."BLABAIR:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."BLABAIR:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."BLABAIR:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."BLABAIR:lockpin"..msg.chat_id_)  
database:srem(bot_id.."BLABAIR:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."BLABAIR:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."BLABAIR:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'BLABAIR:'..lock..msg.chat_id_)    
end
...
if text == ("المطورين") and DevBLABAIR(msg) then
local list = database:smembers(bot_id.."BLABAIR:Sudo:User")
t = "\n◍ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."BLABAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."BLABAIR:Constructor"..msg.chat_id_)
t = "\n◍ قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."BLABAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."BLABAIR:Manager"..msg.chat_id_)
t = "\n◍ قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."BLABAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."BLABAIR:Mod:User"..msg.chat_id_)
t = "\n◍ قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."BLABAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."BLABAIR:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."BLABAIR:Muted:User"..msg.chat_id_)
t = "\n◍ قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."BLABAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."BLABAIR:Ban:User"..msg.chat_id_)
...
function Function_BLABAIR(extra, result, success)
...
if result.sender_user_id_ == tonumber(1962004752) then
send(msg.chat_id_, msg.id_, "◍ لا يمكنك حظر المطور مبرمج السورس  \n")
return false 
end
...
database:sadd(bot_id.."BLABAIR:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◍ تم حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BLABAIR, nil)
return false
end
...
database:sadd(bot_id.."BLABAIR:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","◍ تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"◍ لا يوجد حساب بهاذا المعرف")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BLABAIR, nil)
return false
end
...
if userid == tonumber(1962004752) then
...
database:sadd(bot_id.."BLABAIR:GBan:User", userid)
...
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:GBan:User", result.sender_user_id_)
...
database:srem(bot_id.."BLABAIR:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"◍ لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."BLABAIR:GBan:User", userid)
...
function Function_BLABAIR(extra, result, success)
database:sadd(bot_id.."BLABAIR:Sudo:User", result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Sudo:User", result.id_)
...
database:sadd(bot_id.."BLABAIR:Sudo:User", userid)
...
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Sudo:User", result.sender_user_id_)
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Sudo:User", result.id_)
...
database:srem(bot_id.."BLABAIR:Sudo:User", userid)
...
function Function_BLABAIR(extra, result, success)
database:sadd(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, userid)
...
if da.status_.ID == "ChatMemberStatusCreator" then
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_BLABAIR(extra, result, success)
database:sadd(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Constructor"..msg.chat_id_, userid)
...
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◍ تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BLABAIR, nil)
end
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","◍ تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"◍ لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."BLABAIR:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","◍ تم تنزيله من المنشئين")  
end

if text == ("رفع مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) then 
function Function_BLABAIR(extra, result, success)
database:sadd(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Manager"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","◍ تم ترقيته مدير المجموعه")  
return false
end  
if text == ("تنزيل مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) then 
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."BLABAIR:Manager"..msg.chat_id_, userid)
...
function Function_BLABAIR(extra, result, success)
database:sadd(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","◍ تم ترقيته ادمن للمجموعه")  
return false
end
if text == ("تنزيل ادمن") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then 
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, userid)
...
function Function_BLABAIR(extra, result, success)
database:sadd(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Special:User"..msg.chat_id_, userid)
...
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, userid)
...
usertext = '\n ◍ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ARMY')..')'
local Text = [[
...
if database:sismember(bot_id.."BLABAIR:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local BLABAIRrt = database:get(bot_id.."BLABAIR:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if BLABAIRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n◍ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."BLABAIR:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif BLABAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n◍ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."BLABAIR:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif BLABAIRrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n◍ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."BLABAIR:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif BLABAIRrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n◍ تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif BLABAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n◍ تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."BLABAIR:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local BLABAIRrt = database:get(bot_id.."BLABAIR:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if BLABAIRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n◍ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."BLABAIR:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif BLABAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n◍ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."BLABAIR:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif BLABAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◍ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n◍ تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."BLABAIR:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."BLABAIR:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."BLABAIR:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."BLABAIR:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."BLABAIR:Muted:User"..msg.chat_id_, userid)
...
function Function_BLABAIR(extra, result, success)
database:srem(bot_id.."BLABAIR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLABAIR:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."BLABAIR:Muted:User"..msg.chat_id_, userid)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_BLABAIR, nil)
return false
end
------------------------------------------------------------------------
...
if database:sismember(bot_id.."BLABAIR:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."BLABAIR:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."BLABAIR:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"◍ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"◍ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"◍ تم وضع زمن التكرار ("..Num..")") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"◍ ارسل رابط المجموعه او رابط قناة المجموعه")
database:setex(bot_id.."BLABAIR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."BLABAIR:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."BLABAIR:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◍ تم تعطيل جلب رابط المجموعه") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."BLABAIR:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"◍ جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."BLABAIR:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."BLABAIR:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
if Addictive(msg) then
database:setex(bot_id.."BLABAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."BLABAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."BLABAIR:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."BLABAIR:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."BLABAIR:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"◍ تم تفعيل ترحيب المجموعه") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."BLABAIR:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◍ تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."BLABAIR:Get:Welcome:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◍ تم ازالة ترحيب المجموعه") 
end
return false  
end
if text == 'تفعيل all' and DevBLABAIR(msg) then   
...
if text == 'تعطيل all' and DevBLABAIR(msg) then  
...
local list = database:smembers(bot_id.."BLABAIR:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLABAIR:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BLABAIR:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n◍ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local BLABAIR_Msg = database:get(bot_id.."BLABAIR:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BLABAIR_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"◍ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BLABAIR:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BLABAIR:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"◍ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BLABAIR:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BLABAIR:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BLABAIR:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Addictive(msg) then    
send(msg.chat_id_, msg.id_,"◍ ارسل الكلمه الان")  
database:set(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BLABAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLABAIR:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BLABAIR:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
----------------------------------
if database:get(bot_id.."BLABAIR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "◍ تم الغاء حفظ القوانين") 
database:del(bot_id.."BLABAIR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."BLABAIR:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."BLABAIR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."BLABAIR:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."BLABAIR:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."BLABAIR:List:Cmd:Group:New"..msg.chat_id_.."")
t = "◍ قائمه الاوامر المضافه  \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."BLABAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."BLABAIR:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."BLABAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."BLABAIR:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"◍ تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."BLABAIR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"◍ الان ارسل لي الامر القديم ..")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."BLABAIR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."BLABAIR:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."BLABAIR:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."BLABAIR:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."BLABAIR:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."BLABAIR:Coomds"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"◍ تم مسح الصلاحيات")
end
if text and text:match("^اضف صلاحيه (.*)$") and Addictive(msg) then 
ComdNew = text:match("^اضف صلاحيه (.*)$")
database:set(bot_id.."BLABAIR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."BLABAIR:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."BLABAIR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."BLABAIR:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "◍ تم مسح الصلاحيه ") 
end
if database:get(bot_id.."BLABAIR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"◍ تم الغاء الامر ") 
database:del(bot_id.."BLABAIR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."BLABAIR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."BLABAIR:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."BLABAIR:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◍ تم تغير رد المطور الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."BLABAIR:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◍ تم تغير رد المنشئ الاساسي الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."BLABAIR:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◍ تم تغير رد المنشئ الى » "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."BLABAIR:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"◍ تم تغير رد المدير الى » "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."BLABAIR:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◍ تم تغير رد الادمن الى » "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."BLABAIR:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◍ تم تغير رد المميز الى » "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."BLABAIR:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◍ تم تغير رد العضو الى » "..Teext)
end


if text == ("مسح الردود") and Owner(msg) then
local list = database:smembers(bot_id.."BLABAIR:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."BLABAIR:List:Manager"..msg.chat_id_)
end
...
text = "◍ قائمه الردود \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."BLABAIR:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه ◍"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id.."BLABAIR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."BLABAIR:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."BLABAIR:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"◍ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◍ الان ارسل الرد الذي تريد اضافته \n◍ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n◍ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."BLABAIR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."BLABAIR:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."BLABAIR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."BLABAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."BLABAIR:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."BLABAIR:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'BLABAIR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."BLABAIR:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."BLABAIR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'BLABAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'BLABAIR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, Text)
database:sadd(bot_id.."BLABAIR:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
if text == 'السيرفر' and DevBLABAIR(msg) then 
...
------------------------------------------------------------------------
if text == ("مسح الردود العامه") and DevBLABAIR(msg) then 
local list = database:smembers(bot_id.."BLABAIR:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:File"..v)
database:del(bot_id.."BLABAIR:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."BLABAIR:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◍ تم مسح الردود العامه")
end
if text == ("الردود العامه") and DevBLABAIR(msg) then 
local list = database:smembers(bot_id.."BLABAIR:List:Rd:Sudo")
text = "\n◍ قائمة الردود العامه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Gif"..v) then
db = "متحركه ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:vico"..v) then
db = "بصمه ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:stekr"..v) then
db = "ملصق ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Text"..v) then
db = "رساله ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Photo"..v) then
db = "صوره ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Video"..v) then
db = "فيديو ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:File"..v) then
db = "ملف ◍"
elseif database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ◍"
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."BLABAIR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."BLABAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."BLABAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."BLABAIR:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"◍ تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد عام" and DevBLABAIR(msg) then 
send(msg.chat_id_, msg.id_,"◍ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."BLABAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد عام" and DevBLABAIR(msg) then 
send(msg.chat_id_, msg.id_,"◍ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."BLABAIR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."BLABAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◍ الان ارسل الرد الذي تريد اضافته \n◍ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n◍ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."BLABAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."BLABAIR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."BLABAIR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."BLABAIR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◍ تم ازالة الرد من قائمه الردود العامه")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'BLABAIR:'..v..text)
end
database:del(bot_id.."BLABAIR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."BLABAIR:List:Rd:Sudo", text)
return false
end
end
----------
...
if text == ("مسح الردود المتعدده") and DevBLABAIR(msg) then
...
------------
if text == ("الردود المتعدده") and DevBLABAIR(msg) then
local list = database:smembers(bot_id.."botss:DRAGON:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \nٴ≪┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
db = "رساله "
...
if text == "اضف رد متعدد" and DevBLABAIR(msg) then
...
if text == "حذف رد متعدد" and DevBLABAIR(msg) then
...
if text and not database:get(bot_id.."BLABAIR:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'BLABAIR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."BLABAIR:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."BLABAIR:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."BLABAIR:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."BLABAIR:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."BLABAIR:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."BLABAIR:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."BLABAIR:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."BLABAIR:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."BLABAIR:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."BLABAIR:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."BLABAIR:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
if not database:get(bot_id.."BLABAIR:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id..'BLABAIR:Lock:Added:Me'..msg.chat_id_)  
send(msg.id_,'◍ تم تفعيل امر منو ضافني') 
return false
end
if text == 'تعطيل مين ضافني' and Owner(msg) then  
database:set(bot_id..'BLABAIR:Lock:Added:Me'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'◍ تم تعطيل امر مين ضافني') 
return false
end

if text and text:match("(.*)(مين ضافني)(.*)") then
if not database:get(bot_id..'BLABAIR:Lock:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'◍ انت منشئ المجموعه ') 
return false
end
local Added_Me = database:get(bot_id.."BLABAIR:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
database:del(bot_id.."BLABAIR:Kick:Me"..msg.chat_id_)  
Text = "\n◍ تم تفعيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."BLABAIR:Kick:Me"..msg.chat_id_,true)  
Text = "\n◍ تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_BLABAIR(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."BLABAIR:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."BLABAIR:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_BLABAIR(extra, result, success)
if database:sismember(bot_id.."BLABAIR:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."BLABAIR:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."BLABAIR:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, admins[i].user_id_)
nu2 = nu2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."BLABAIR:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
-------
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBLABAIR(msg) then
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and DevBLABAIR(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and DevBLABAIR(msg) then
...
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBLABAIR(msg) then
function Function_BOYKA(extra, result, success)
...
if text and text:match("^تنزيل مطور ثانوي @(.*)$") and DevBLABAIR(msg) then
...
if text and text:match("^تنزيل مطور ثانوي (%d+)$") and DevBLABAIR(msg) then
...
if text == ("الثانويين") and DevBLABAIR(msg) then
...
if text == ("مسح الثانويين") and DevBLABAIR(msg) then
...
local UserName = (b.username_ or "SOURCE_ARMY")
...
database:sadd(bot_id.."BLABAIR:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."BLABAIR:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"◍ تم مغادرة المجموعه") 
database:srem(bot_id.."BLABAIR:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."BLABAIR:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevBLABAIR(msg) then   
database:del(bot_id.."BLABAIR:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"◍ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevBLABAIR(msg) then  
database:set(bot_id.."BLABAIR:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "◍ تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."BLABAIR:Name:Bot") or "جوكر") then
Namebot = (database:get(bot_id.."BLABAIR:Name:Bot") or "جوكر")
local namebot = {
'◍ يوه '..Namebot..' زهق منك😒',
'◍ نعم ياعيون '..Namebot..' 😻💓',
'◍ عايز اي من '..Namebot..' 🙄💛',
...
if DevBLABAIR(msg) then
database:setex(bot_id.."BLABAIR:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."BLABAIR:Status:Bc") and not DevBOYKAW(msg) then 
send(msg.chat_id_, msg.id_,"◍ الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."BLABAIR:BLABAIR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."BLABAIR:BLABAIR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n◍ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."BLABAIR:BLABAIR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n◍ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."BLABAIR:BLABAIR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."BLABAIR:BLABAIR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevBOYKAW(msg) then  
database:del(bot_id.."BLABAIR:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n◍ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevBOYKAW(msg) then  
database:set(bot_id.."BLABAIR:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n◍ تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."BLABAIR:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."BLABAIR:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."BLABAIR:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."BLABAIR:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقييد"     
elseif database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقييد"    
elseif database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقييد"    
elseif database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقييد"    
elseif database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقييد"    
elseif database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقييد"   
elseif database:get(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقييد"    
elseif database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."BLABAIR:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."BLABAIR:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."BLABAIR:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."BLABAIR:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."BLABAIR:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."BLABAIR:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."BLABAIR:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."BLABAIR:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n◍ ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n◍ علامة ال {✓} تعني مفعل"..
...
database:setex(bot_id.."BLABAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
◍ ارسل الان النص
◍ يمكنك اضافه :
- `#username` > اسم المستخدم
...
if Owner(msg) then
database:del(bot_id.."BLABAIR:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '◍ تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."BLABAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"◍ تم الغاء تعين الايدي") 
database:del(bot_id.."BLABAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."BLABAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."BLABAIR:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'◍ تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'BLABAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'BLABAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."BLABAIR:Spam:Group"..msg.sender_user_id_,text) 
...
local Add_Mem = database:get(bot_id.."BLABAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."BLABAIR:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'BLABAIR:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if text == 'صورتي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'BLABAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'BLABAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."BLABAIR:Spam:Group"..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,taha,success) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
local NumMsg = database:get(bot_id..'BLABAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'BLABAIR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."BLABAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Total_Photp = (taha.total_count_ or 0)
...
local Id = data.id_
local NumMsg = database:get(bot_id..'BLABAIR:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."BLABAIR:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'BLABAIR:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."BLABAIR:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'BLABAIR:Lock:ID:Bot'..msg.chat_id_) then
...
◍ بضغط ع الزر بلاسفل ..🎮
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◍ CH - [『 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐑𝐌𝐘 』](t.me/SOURCE_ARMY) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {} 
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'BLABAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '◍ عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'BLABAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◍ تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'BLABAIR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '◍ عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'BLABAIR:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◍ تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."BLABAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '◍ عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'BLABAIR:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."BLABAIR:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."BLABAIR:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."BLABAIR:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "مسح المشتركين" and DevBLABAIR(msg) then
local pv = database:smembers(bot_id..'BLABAIR:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'BLABAIR:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "مسح الجروبات" and DevBLABAIR(msg) then
local group = database:smembers(bot_id..'BLABAIR:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'BLABAIR:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevBLABAIR(msg) then  
send(msg.chat_id_,msg.id_,'◍ تم التحديث')
os.execute('rm -rf BLABAIR.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/jaxso0n/jaxson/master/BLABAIR.lua', 'BLABAIR.lua') 
...
if text == 'تفعيل البوت الخدمي' and DevBLABAIR(msg) then  
database:del(bot_id..'BLABAIR:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'◍ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevBLABAIR(msg) then  
database:set(bot_id..'BLABAIR:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'◍ تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevBLABAIR(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'BLABAIR:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'◍ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'BLABAIR:Chek:Groups')  
local Users = database:scard(bot_id..'BLABAIR:UsersBot')  
send(msg.chat_id_, msg.id_,'◍ احصائيات البوت \n\n◍ عدد المجموعات *~ '..Groups..'\n◍ عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevBLABAIR(msg) then
local list = database:smembers(bot_id..'BLABAIR:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'BLABAIR Chat'
ASAS = database:smembers(bot_id.."BLABAIR:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."BLABAIR:Constructor"..v)
MDER = database:smembers(bot_id.."BLABAIR:Manager"..v)
MOD = database:smembers(bot_id.."BLABAIR:Mod:User"..v)
link = database:get(bot_id.."BLABAIR:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"BLABAIR":"'..NAME..'",'
else
t = t..',"'..v..'":{"BLABAIR":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'BLABAIR:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevBLABAIR(msg) then
t = '◍ جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls BLABAIR_Files'):lines() do
if v:match(".lua$") then
...
local Check_File_is_Found = io.open("BLABAIR_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevBLABAIR(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("BLABAIR_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/jaxso0n/jaxson/master/files_BLABAIR/"..file)
if res == 200 then
os.execute("rm -fr BLABAIR_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SOURCE_ARMY.lua')  
else
send(msg.chat_id_, msg.id_,"*◍ عذرا لا يوجد هاكذا ملف في المتجر *\n") 
end
return false
end
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevBLABAIR(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/jaxso0n/jaxson/master/files_BLABAIR/"..file)
if res == 200 then
local chek = io.open("BLABAIR_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevBLABAIR(msg) then
os.execute("rm -fr BLABAIR_Files/*")
send(msg.chat_id_,msg.id_,"◍ تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevBLABAIR(msg) then
local Users = database:smembers('BLABAIR:'..bot_id.."userss")
local Groups = database:smembers('BLABAIR:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'BLABAIR:Chek:Groups',Groups[i])  
local list1 = database:smembers('BLABAIR:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."BLABAIR:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('BLABAIR:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."BLABAIR:Constructor"..Groups[i], v)
end
local list3 = database:smembers('BLABAIR:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."BLABAIR:Manager"..Groups[i], v)
end
local list4 = database:smembers('BLABAIR:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."BLABAIR:Mod:User"..Groups[i], v)
end
database:set(bot_id.."BLABAIR:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'BLABAIR:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
database:sadd(bot_id..'BLABAIR:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'◍ تم نقل : '..#Groups..' كروب\n◍ تم نقل : '..#Users..' مشترك \n◍ من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevBLABAIR(msg) then
database:del(bot_id..'BLABAIR:Text_Dev')
send(msg.chat_id_, msg.id_,'◍ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevBLABAIR(msg) then
database:set(bot_id..'BLABAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'◍ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'BLABAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'BLABAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◍ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'BLABAIR:Text_Dev',text)
database:del(bot_id..'BLABAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◍ تم حفظ كليشة المطور')
return false
end
if text == 'رفع النسخه الاحتياطيه' and DevBLABAIR(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevBLABAIR(msg) then
dofile("BLABAIR.lua")  
send(msg.chat_id_, msg.id_, "◍ تم التحديث")
end
-----Zhrfa--------
...
send(msg.chat_id_, msg.id_, t..'═───═𝐀𝐑𝐌𝐘═───═\n◍ CH - [『 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐑𝐌𝐘 』](t.me/SOURCE_ARMY)  ')
end

-----
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == '"' then
local Text =[[
┍─━─━─┙[𝐀𝐑𝐌𝐘](t.me/SOURCE_ARMY)┕─━─━─┑
◍ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴀʀᴍʏ
...
{
{text = '◍ 𝙳𝙴𝚅 ʙᴏᴅʏ ', url = "https://t.me/Xx_BoDa_UXB"}
},
{
{text = '◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂', url = "https://t.me/SOURCE_ARMY"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_ARMY&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
------------
...
if text == 'بودي' or text == 'عبدالرحمن' or text == 'body' or text == '"' then
local Text =[[
◍ بودي صاحبه السورس التواصل
◍ عن طريق معرفه في الاسفل ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝗕𝗢𝗗𝗬', url = "https://t.me/Xx_BoDa_UXB"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Xx_BoDa_UXB&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = 'ᴛᴡᴀ', url = "https://t.me/TW_A_RM_Y_Bot"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TW_A_RM_Y_Bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تابع جديدنا من فضلك ',url="t.me/SOURCE_ARMY"}}, 
...
----------
if not database:get(bot_id..'BLABAIR:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
...
database:del(bot_id..'BLABAIR:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'◍ تم تفعيل الردود')
return false
end

if text == 'تعطيل ردود السورس' and Owner(msg) then
database:set(bot_id..'BLABAIR:Reply:Mute'..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,'◍ تم تعطيل الردود')
return false
end
----------
...
彡 .[SOURCE BLABAIR ◍](t.me/SOURCE_ARMY)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'BLABAIR:Num:Add:Bot') or 0) and not DevBLABAIR(msg) then
send(msg.chat_id_, msg.id_,'◍ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'BLABAIR:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'BLABAIR:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'◍ المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','◍ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'BLABAIR:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'BLABAIR:Chek:Groups',msg.chat_id_) then
...
database:set(bot_id.."BLABAIR:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'BLABAIR:Free:Add:Bots') then 
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'◍ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
Reply_Status(msg,result.id_,'reply_Add','◍ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'BLABAIR:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'BLABAIR:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'BLABAIR:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'BLABAIR:Start:Time'..msg.sender_user_id_,60,true)
return false
end
...
database:del(bot_id.."BLABAIR:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLABAIR:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLABAIR:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'BLABAIR:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'BLABAIR:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLABAIR:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLABAIR:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLABAIR:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLABAIR:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLABAIR:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'BLABAIR:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'BLABAIR:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLABAIR:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."BLABAIR:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."BLABAIR:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."BLABAIR:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."BLABAIR:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."BLABAIR:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."BLABAIR:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:srem(bot_id..'BLABAIR:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:del(bot_id..'BLABAIR:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'BLABAIR:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 

if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'BLABAIR:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
if text and not database:sismember(bot_id..'BLABAIR:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'BLABAIR:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'BLABAIR:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."BLABAIR:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."BLABAIR:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."BLABAIR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."BLABAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."BLABAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."BLABAIR:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."BLABAIR:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."BLABAIR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."BLABAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."BLABAIR:Name:Bot") or "جوكر")
if not database:get(bot_id.."BLABAIR:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
BLABAIR_Started_Bot(msg,data)
BLABAIR_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'BLABAIR:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."BLABAIR:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
if database:get(bot_id.."BLABAIR:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."BLABAIR:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."BLABAIR:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."BLABAIR:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local BLABAIR_Msg = database:get(bot_id.."BLABAIR:Add:Filter:Rp2"..text..result.chat_id_)   
if BLABAIR_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","◍ "..BLABAIR_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'BLABAIR:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'BLABAIR:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'BLABAIR:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'BLABAIR:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'BLABAIR:Chek:Groups',v)  
end
...
database:sadd(bot_id..'BLABAIR:Chek:Groups',v)  
end end,nil)
end;end;end
